...
Это снимок первоначальной разведки. Последующие изменения и проверки:
[журнал этапов](stages.md). После предоставления ТЗ пользователь разрешил
[синтезировать недостающую историю и словари](synthetic_data.md).
